...
router.get("/all/:pageSize/:cursorId?", isAuth, questionsController.getAllPaginated);

router.get("/:question", isAuth, questionsController.getQuestion);
router.get("/like/:questionId/:operation", isAuth, questionsController.addQuestionLike);
router.get("/subscribe/:questionId/:operation", isAuth, questionsController.addSubscription);
